Feature:  Cashwise Login
  ...
  Scenario Outline: Verifying the login functionality with invalid credentials
   ...
   #   | test        | test     | https://cashwise.us/main?showLogin=true |
    #  | hi@test.com | test     | https://cashwise.us/main?showLogin=true |
     # |             | test     | https://cashwise.us/main?showLogin=true |
      | hi@test     |          | https://cashwise.us/main?showLogin=true |



  Scenario Outline: Verifying the login functionality with valid credentials
